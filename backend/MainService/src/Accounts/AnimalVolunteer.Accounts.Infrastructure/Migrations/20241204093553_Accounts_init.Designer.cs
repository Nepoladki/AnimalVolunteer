...
namespace AnimalVolunteer.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20241204093553_Accounts_init")]
            ...
            modelBuilder.Entity("AnimalVolunteer.Accounts.Domain.Models.User", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("FullName", "AnimalVolunteer.Accounts.Domain.Models.User.FullName#FullName", b1 =>
                        {
                            b1.IsRequired();
